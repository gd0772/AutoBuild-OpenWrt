...
<li> Plage IP: l'adresse IP correspond à la plage; par exemple: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.loginCheck.desc"          => "<h5 class=\"mb-15\"> <b>Instructions de contrôle de restriction de connexion utilisateur (restrictions d'IP et de périphérique):</b></h5><li> Détecter dans l'ordre en fonction de la priorité de la règle; l&#39;utilisateur spécifié par la règle comprend l&#39;utilisateur actuellement connecté; la règle est déterminée comme le résultat</li><li> Il est recommandé de placer les groupes d&#39;utilisateurs et les utilisateurs départementaux à l&#39;arrière et de spécifier les paramètres utilisateur à l&#39;avant; (glisser-déposer pour ajuster l&#39;ordre)</li>",
    ...
    "admin.setting.phpExt"           => "Extension PHP",
    ...
    "admin.setting.ifSaveDb"         => "Le changement de base de données consiste à importer les données de la base de données système actuelle dans une nouvelle base de données et à définir la nouvelle base de données comme base de données système. Êtes-vous sûr de vouloir exécuter?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Votre adresse IP actuelle ou votre appareil d'accès n'est pas autorisé à se connecter, veuillez contacter l&#39;administrateur!",
    ...
    "admin.share.disAsReport"        => "Ce fichier a été signalé par les utilisateurs et a été bloqué de partage",
