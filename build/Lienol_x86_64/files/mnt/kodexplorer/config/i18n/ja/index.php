...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "パスワードが5回連続して間違っており、アカウントが30秒間ロックされてログインが許可されていません。開いた後は、パスワードがブルートフォースクラッキングされるのを効果的に防ぐことができます。",
...
<li> IP範囲：IPは範囲内で一致します。例：192.168.1.1-192.168.200.255</li>",
    ...
    "admin.loginCheck.desc"          => "<h5 class=\"mb-15\"><b>ユーザーログイン制限制御手順（IPおよびデバイス制限）：</b></h5><li>ルールの優先度に従って順番に検出します。ルールで指定されたユーザーには、現在ログインしているユーザーが含まれます。ルールは結果として決定されます。</li><li>ユーザーグループと部門ユーザーを背面に配置し、ユーザー設定を前面に指定することをお勧めします;（ドラッグアンドドロップで順序を調整します）</li>",
    ...
    "admin.setting.ifSaveDb"         => "データベースの切り替えは、現在のシステムデータベースデータを新しいデータベースにインポートし、新しいデータベースをシステムデータベースとして設定することです。実行してもよろしいですか？",
    ...
    "admin.share.disAsReport"        => "このファイルはユーザーによって報告され、共有がブロックされています",
