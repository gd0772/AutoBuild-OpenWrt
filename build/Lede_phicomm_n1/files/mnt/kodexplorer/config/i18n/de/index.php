...
return array(
    ...
    "admin.loginCheck.menu"          => "Anmeldesteuerung",
...
<li> IP-Bereich: IP-Übereinstimmungen innerhalb des Bereichs, z. B. 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.loginCheck.desc"          => "<h5 class=\"mb-15\"> <b>Anweisungen zur Kontrolle der Benutzeranmeldebeschränkungen (IP- und Geräteeinschränkungen):</b></h5><li> Nacheinander nach der Priorität der Regel erkennen, der in der Regel angegebene Benutzer enthält den aktuell angemeldeten Benutzer, die Regel wird als Ergebnis ermittelt</li><li> Es wird empfohlen, Benutzergruppen und Abteilungsbenutzer auf der Rückseite zu platzieren und Benutzereinstellungen auf der Vorderseite anzugeben (Ziehen und Ablegen, um die Reihenfolge anzupassen).</li>",
    ...
    "admin.setting.phpExt"           => "PHP-Erweiterung",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Ihre aktuelle IP-Adresse oder Ihr Zugriffsgerät darf sich nicht anmelden. Bitte wenden Sie sich an den Administrator!",
    ...
    "admin.share.disAsReport"        => "Diese Datei wurde von Benutzern gemeldet und für die Freigabe gesperrt",
