...
<li> IP aralığı: ip, aralık dahilinde eşleşir; örneğin: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.loginCheck.desc"          => "<h5 class=\"mb-15\"> <b>Kullanıcı girişi kısıtlama kontrol talimatları (ip ve cihaz kısıtlamaları):</b></h5><li> Kuralın önceliğine göre sırayla tespit edin; kural tarafından belirtilen kullanıcı o anda oturum açmış olan kullanıcıyı içerir; sonuç olarak kural belirlenir</li><li> Kullanıcı gruplarını ve departman kullanıcılarını arkaya koymanız ve ön tarafta kullanıcı ayarlarını belirtmeniz önerilir; (sırayı ayarlamak için sürükle ve bırak)</li>",
    ...
    "admin.setting.phpExt"           => "PHP uzantısı",
    ...
    "admin.setting.ifSaveDb"         => "Veritabanı değişimi, mevcut sistem veritabanı verilerini yeni bir veritabanına aktarmak ve yeni veritabanını sistem veritabanı olarak ayarlamaktır. Yürütmek istediğinizden emin misiniz?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Mevcut IP'nizin veya erişim cihazınızın oturum açmasına izin verilmiyor, lütfen yönetici ile iletişime geçin!",
    ...
    "admin.share.disAsReport"        => "Bu dosya kullanıcılar tarafından bildirildi ve paylaşılması engellendi",
