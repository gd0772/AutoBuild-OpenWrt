...
<li> Rango de IP: coincidencias de IP dentro del rango; por ejemplo: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.loginCheck.desc"          => "<h5 class=\"mb-15\"> <b>Instrucciones de control de restricción de inicio de sesión de usuario (restricciones de dispositivo e IP):</b></h5><li> Detectar en secuencia de acuerdo con la prioridad de la regla; el usuario especificado por la regla incluye al usuario actualmente conectado; la regla se determina como resultado</li><li> Se recomienda colocar los grupos de usuarios y los usuarios departamentales en la parte posterior, y especificar la configuración del usuario en el frente; (arrastre y suelte para ajustar el orden)</li>",
    ...
    "admin.setting.phpExt"           => "Extensión PHP",
    ...
    "admin.setting.ifSaveDb"         => "El cambio de base de datos consiste en importar los datos de la base de datos del sistema actual a una nueva base de datos y establecer la nueva base de datos como la base de datos del sistema. ¿Estás seguro de que quieres ejecutar?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Su IP actual o dispositivo de acceso no tiene permitido iniciar sesión, ¡comuníquese con el administrador!",
    ...
    "admin.share.disAsReport"        => "Los usuarios han informado de este archivo y no se puede compartir",
 ...
 post_max_size, necesita reiniciar)",
    ...
    "common.language"                => "multi lenguaje",
    "common.all"                     => "Todos",
