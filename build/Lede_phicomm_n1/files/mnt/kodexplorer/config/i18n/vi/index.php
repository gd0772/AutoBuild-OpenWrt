...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "Nếu nhập sai mật khẩu 5 lần liên tiếp, tài khoản sẽ bị khóa trong 30 giây và không được đăng nhập, sau khi mở, nó có thể ngăn chặn rất hiệu quả việc bẻ khóa mật khẩu;",
...
<li> Dải IP: ip khớp trong dải; ví dụ: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.loginCheck.desc"          => "<h5 class=\"mb-15\"> <b>Hướng dẫn kiểm soát hạn chế đăng nhập của người dùng (hạn chế ip và thiết bị):</b></h5><li> Phát hiện theo thứ tự theo mức độ ưu tiên của quy tắc; người dùng được chỉ định bởi quy tắc bao gồm người dùng hiện đang đăng nhập; quy tắc được xác định theo kết quả</li><li> Bạn nên đặt nhóm người dùng và người dùng phòng ban ở phía sau và chỉ định cài đặt người dùng ở phía trước; (kéo và thả để điều chỉnh thứ tự)</li>",
    ...
    "admin.setting.phpExt"           => "Phần mở rộng PHP",
    ...
    "admin.setting.ifSaveDb"         => "Chuyển đổi cơ sở dữ liệu là nhập dữ liệu cơ sở dữ liệu hệ thống hiện tại sang cơ sở dữ liệu mới và đặt cơ sở dữ liệu mới làm cơ sở dữ liệu hệ thống. Bạn có chắc chắn muốn thực hiện không?",
    ...
    "admin.share.disAsReport"        => "Tệp này đã được người dùng báo cáo và đã bị chặn chia sẻ",
