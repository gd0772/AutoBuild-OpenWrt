...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "หากรหัสผ่านไม่ถูกต้องติดต่อกัน 5 ครั้งบัญชีจะถูกล็อคเป็นเวลา 30 วินาทีและไม่อนุญาตให้เข้าสู่ระบบหลังจากเปิดแล้วจะสามารถป้องกันรหัสผ่านจากการแคร็กแรงอย่างมีประสิทธิภาพ",
...
<li> ช่วง IP: ip ตรงกันภายในช่วงตัวอย่างเช่น 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.loginCheck.desc"          => "<h5 class=\"mb-15\"> <b>คำแนะนำการควบคุมข้อ จำกัด การเข้าสู่ระบบของผู้ใช้ (ข้อ จำกัด IP และอุปกรณ์):</b></h5><li> ตรวจจับตามลำดับตามลำดับความสำคัญของกฎผู้ใช้ที่ระบุโดยกฎรวมถึงผู้ใช้ที่เข้าสู่ระบบในปัจจุบันกฎจะถูกกำหนดเป็นผลลัพธ์</li><li> ขอแนะนำให้วางกลุ่มผู้ใช้และผู้ใช้แผนกไว้ด้านหลังและระบุการตั้งค่าผู้ใช้ที่ด้านหน้า (ลากและวางเพื่อปรับลำดับ)</li>",
    ...
    "admin.setting.phpExt"           => "นามสกุล PHP",
    ...
    "admin.setting.ifSaveDb"         => "การสลับฐานข้อมูลคือการนำเข้าข้อมูลฐานข้อมูลระบบปัจจุบันไปยังฐานข้อมูลใหม่และตั้งฐานข้อมูลใหม่เป็นฐานข้อมูลระบบ แน่ใจไหมว่าต้องการดำเนินการ",
    ...
    "ERROR_IP_NOT_ALLOW"             => "IP หรืออุปกรณ์การเข้าถึงปัจจุบันของคุณไม่ได้รับอนุญาตให้เข้าสู่ระบบโปรดติดต่อผู้ดูแลระบบ!",
    ...
    "admin.share.disAsReport"        => "ไฟล์นี้ได้รับการรายงานโดยผู้ใช้และถูกบล็อกไม่ให้แชร์",
