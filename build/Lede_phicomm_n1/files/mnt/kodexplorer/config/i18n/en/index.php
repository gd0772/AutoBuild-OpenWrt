...
<li> IP range: ip matches within the range; for example: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.loginCheck.desc"          => "<h5 class=\"mb-15\"> <b>User login restriction control instructions (ip and device restrictions):</b></h5><li> Detect in sequence according to the priority of the rule; the user specified by the rule includes the currently logged-in user; the rule is determined as the result</li><li> It is recommended to put user groups and departmental users on the back, and specify user settings on the front; (drag and drop to adjust the order)</li>",
    ...
    "admin.setting.srvStateDef"      => "The default storage space of the network disk",
    ...
    "admin.setting.phpExt"           => "PHP extension",
    ...
    "admin.setting.ifSaveDb"         => "Database switching is to import the current system database data to a new database and set the new database as the system database. Are you sure you want to execute?",
    ...
    "admin.share.disAsReport"        => "This file has been reported by users and has been blocked from sharing",
 ...
 post_max_size, need to restart)",
    ...
    "common.language"                => "Multi-language",
    "common.all"                     => "All",
    "common.item"                    => "Item",
