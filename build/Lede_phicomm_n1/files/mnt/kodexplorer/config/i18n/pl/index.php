...
return array(
    ...
    "admin.setting.passwordErrorLockDesc" => "Jeśli hasło jest niepoprawne 5 razy z rzędu, konto jest blokowane na 30 sekund i logowanie jest zabronione.Po otwarciu może skutecznie zapobiec brutalnemu złamaniu hasła;",
...
<li> Zakres adresów IP: ip pasuje do zakresu; na przykład: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.loginCheck.desc"          => "<h5 class=\"mb-15\"> <b>Instrukcje dotyczące kontroli ograniczeń logowania użytkownika (ograniczenia dotyczące adresów IP i urządzeń):</b></h5><li> Wykrywaj w kolejności zgodnie z priorytetem reguły; użytkownik określony przez regułę obejmuje aktualnie zalogowanego użytkownika; reguła jest określana jako wynik</li><li> Zaleca się umieszczenie grup użytkowników i użytkowników działowych z tyłu i określenie ustawień użytkownika z przodu; (przeciągnij i upuść, aby dostosować kolejność)</li>",
    ...
    "admin.setting.phpExt"           => "Rozszerzenie PHP",
    ...
    "admin.setting.ifSaveDb"         => "Przełączanie bazy danych polega na zaimportowaniu danych bieżącej bazy danych systemu do nowej bazy danych i ustawieniu nowej bazy danych jako bazy danych systemu. Czy na pewno chcesz wykonać?",
    ...
    "ERROR_IP_NOT_ALLOW"             => "Twoje aktualne IP lub urządzenie dostępowe nie ma uprawnień do logowania, skontaktuj się z administratorem!",
    ...
    "admin.share.disAsReport"        => "Ten plik został zgłoszony przez użytkowników i nie można go udostępniać",
 ...
 post_max_size, trzeba zrestartować)",
    ...
    "log-event-edit"                 => "Zaktualizowano plik",
