...
return array(
    ...
    "admin.loginCheck.menu"          => "مراقبة تسجيل الدخول",
...
<li> نطاق IP: تطابق IP ضمن النطاق ؛ على سبيل المثال: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.loginCheck.desc"          => "<h5 class=\"mb-15\"> <b>تعليمات التحكم في قيود تسجيل دخول المستخدم (قيود IP والجهاز):</b></h5><li> الكشف بالتسلسل وفقًا لأولوية القاعدة ؛ يتضمن المستخدم المحدد بواسطة القاعدة المستخدم المسجل حاليًا ؛ يتم تحديد القاعدة كنتيجة</li><li> يوصى بوضع مجموعات المستخدمين والمستخدمين الإداريين في الخلف ، وتحديد إعدادات المستخدم في المقدمة ؛ (قم بالسحب والإفلات لضبط الترتيب)</li>",
    ...
    "admin.setting.phpExt"           => "امتداد PHP",
    ...
    "admin.setting.ifSaveDb"         => "تبديل قاعدة البيانات هو استيراد بيانات قاعدة بيانات النظام الحالية إلى قاعدة بيانات جديدة وتعيين قاعدة البيانات الجديدة كقاعدة بيانات النظام. هل أنت متأكد أنك تريد التنفيذ؟",
    ...
    "admin.share.disAsReport"        => "تم الإبلاغ عن هذا الملف من قبل المستخدمين وتم حظر مشاركته",
