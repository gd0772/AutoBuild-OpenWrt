...
<li> Intervalo de IP: correspondências de ip dentro do intervalo; por exemplo: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.setting.phpExt"           => "Extensão PHP",
    ...
    "admin.setting.ifSaveDb"         => "A troca de banco de dados consiste em importar os dados do banco de dados do sistema atual para um novo banco de dados e definir o novo banco de dados como o banco de dados do sistema. Tem certeza que deseja executar?",
    ...
    "admin.share.disAsReport"        => "Este arquivo foi denunciado por usuários e seu compartilhamento foi bloqueado",
