...
return array(
    ...
    "admin.loginCheck.menu"          => "Kontrol login",
...
<li> Rentang IP: kecocokan ip dalam rentang tersebut; misalnya: 192.168.1.1-192.168.200.255</li>",
    ...
    "admin.loginCheck.desc"          => "<h5 class=\"mb-15\"> <b>Petunjuk kontrol pembatasan login pengguna (pembatasan ip dan perangkat):</b></h5><li> Mendeteksi secara berurutan sesuai dengan prioritas aturan; pengguna yang ditentukan oleh aturan termasuk pengguna yang saat ini masuk; aturan ditentukan sebagai hasil</li><li> Direkomendasikan untuk menempatkan grup pengguna dan pengguna departemen di belakang, dan menentukan pengaturan pengguna di depan; (seret dan lepas untuk menyesuaikan urutan)</li>",
    ...
    "admin.setting.phpExt"           => "Ekstensi PHP",
    ...
    "ERROR_IP_NOT_ALLOW"             => "IP atau perangkat akses Anda saat ini tidak diizinkan untuk masuk, harap hubungi administrator!",
    ...
    "admin.share.disAsReport"        => "File ini telah dilaporkan oleh pengguna dan telah diblokir dari berbagi",
